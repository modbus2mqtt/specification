...
import { Ivalue, Ientity, ModbusFunctionCodes, Ispecification } from 'specification.shared';
...
export class TextConverter extends Converter {
    ...
    override modbus2mqtt(spec: Ispecification, entityid: number, value: ReadRegisterResult): number | string {
        ...
        if (entity && entity.converter.name === "value_sensor" && entity.converterParameters && (entity.converterParameters as Ivalue).value)
